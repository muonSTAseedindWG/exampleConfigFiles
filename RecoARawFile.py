...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('/store/user/hbrun/seedTreesTSGsample/subsetByType/events_STAZ2_fail.root')
#    fileNames = cms.untracked.vstring('/store/user/hbrun/seedTreesTSGsample/subsetByType/events_SeedZ0_pass.root')
)
